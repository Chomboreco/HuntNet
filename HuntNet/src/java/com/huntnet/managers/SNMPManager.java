...
public class SNMPManager {
    ...
    /**
     * Start the Snmp session. If you forget the listen() method you will not get any answers because the communication is asynchronous and the listen() method listens
     * for answers.
     *
     * @throws IOException
     */
