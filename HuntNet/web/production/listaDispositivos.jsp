                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Dispositivos <small>lista completa de dispositivos</small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <c:set var="devices" value="${requestScope.dispositivos}"/>
                                                <c:set var="counter" value="${counter = 0}"/>

                                                <c:forEach var="device" items="${devices}">
                                                    <tr>
                                                        <th scope="row"><c:out value="${counter = counter + 1}"/></th>
                                                        <td><c:out value="${device.ip}"/></td>
                                                        <td><c:out value="${device.os}"/></td>
                                                        <td><c:out value="${device.community}"/></td>
                                                        <td><c:out value="${device.systemUpTime}"/></td>
                                                        <td><a href="Dispositivo?action=ver&ip=<c:out value="${device.ip}"/>"><i class="fa fa-eye"></i> Ver</a></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
